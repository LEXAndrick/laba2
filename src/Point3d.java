...
public class Point3d extends Point2d {
...

    {
        ...
        if(compare(Point, Point1))                              //Сравниваем координаты точек
            ...
            System.out.println("Points have different coordinates.");//Если расстояние между точками разное
            System.out.println("Distance between points: ");   //Рассчитываем расстояние между точками
